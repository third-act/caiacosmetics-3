# BRIEF — CAIA Cosmetics (caiacosmetics-3)
...
**New project (inbound REPLAY).** Slug `caiacosmetics-3`, repo `third-act/caiacosmetics-3`. Prior demofabrikk content on this slug wiped 10 Sep. Do **not** reuse `caiacosmetics` / `caiacosmetics-2` code, seed, photos, or URLs. QA: https://www.thirdact.no/demo/caiacosmetics-3. Customer: https://www.thirdact.se/caiacosmetics-3 (form/market **SE** → `.se`). Skills pin: `8873529`. Track: **Demo Web / Composer** (not Demo Web Opus).

Do **not** contact the brand. Never put `info@caiacosmetics.com` in the UI. Form To `schultziie@icloud.com` — never in UI.
...
| Slug | caiacosmetics-3 |
| Form To | schultziie@icloud.com — never in UI |
| Customer URL | https://www.thirdact.se/caiacosmetics-3 |
| QA | https://www.thirdact.no/demo/caiacosmetics-3 |
